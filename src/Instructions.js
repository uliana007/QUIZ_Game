...
const instructionSteps = [
  {
    ...
    {
      text: "Секундомер",
      description: "Здесь отображается оставшееся время на ответ", // Описание
      highlight: { top: "48%", left: "67%", width: "90px", height: "45px" },
      boxImage: require("./assets/png/33.png"),
      boxPosition: { top: "80%", left: "50%" }, // Позиция
      boxSize: { width: "200px", height: "190px" }, // Размеры
    },
  ];
...
const Instructions = ({ startGame }) => {
  ...
  style={{
    ...
    width: instructionSteps[step].boxSize.width, // Устанавливает ширину
    height: instructionSteps[step].boxSize.height, // Устанавливает высоту
